...
Compilers (Webpack, esbuild, SWC), Micro-services (Module Federation, Event Driven Architecture), REST APIs`),
          toParagraph(`
<strong>CI/CD -</strong> 
Jenkins, Git (MonoRepos, Pipelines), TDD (Jest, PACT, Testing Library)`),
          toParagraph(`
<strong>Other -</strong> 
...
Senior Consultant (Javascript Tech Lead)`),
      ...
      },
      {
        ...
        copy: [
          toParagraph(
            `I have been at Sharp Gaming for over five years, working on a large-scale project to modernise the Betfred Website. Major 
